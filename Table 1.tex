...
$\tau$\textsubscript{deact} (ms) & 0.93 $\pm$ 0.14 (6)\tnote{a} & NA & 2.6 $\pm$ 0.2\tnote{a}\tnote{b}\cite{11927664} & 3.6 $\pm$ 0.4\tnote{a}\tnote{b}\cite{11927664} & {\bf 1.12 $\pm$ 0.1\tnote{a}\tnote{b}\cite{11927664}} \\ \addlinespace
...
\end{tabular}
    \begin{tablenotes}
        ...
        \item[\textsuperscript{b}] 2 mM Ca\textsuperscript{2+}
        \item[\textsuperscript{c}] \textminus30 mV as test potential
        \end{flushleft}
    \end{tablenotes}
\end{threeparttable}
\end{center}
