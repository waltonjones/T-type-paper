...
$\tau$\textsubscript{deact} (ms) & 0.93 $\pm$ 0.14 (6)\tnote{a} & NA & 2.6 $\pm$ 0.2\tnote{a}\tnote{+}\cite{11927664} & 3.6 $\pm$ 0.4\tnote{a}\tnote{+}\cite{11927664} & {\bf 1.12 $\pm$ 0.1\tnote{a}\tnote{+}\cite{11927664}} \\ \addlinespace
...
\multirow{2}{*}{Ni\textsuperscript{2+} (IC\textsubscript{50} $\mu$M)} & \multirow{2}{*}{5.1 (6-12)} & \multirow{2}{*}{276.5 (5-6)} & 167 $\pm$ 15\tnote{*}\cite{lee:1999ab} & {\bf 5.7 $\pm$ 0.3\tnote{*}\cite{lee:1999ab}} & 87 $\pm$ 7\tnote{*}\cite{lee:1999ab} \\ \addlinespace
...
\end{tabular}
    \begin{tablenotes}
        ...
        \item[*] \textminus30 as testpotential
        \item[+] 2 mM Ca\textsuperscript{2+}
        \end{flushleft}
    \end{tablenotes}
\end{threeparttable}
\end{center}
