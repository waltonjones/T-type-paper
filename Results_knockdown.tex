...
Pan-neuronal knockdown of DmCa\textsubscript{v}3 (\emph{elav-gal4\textgreater{}UAS-DmCa\textsubscript{v}3-IR) increases sleep beyond that of heterozygous controls under both LD and DD conditions (Fig \ref{fig:5}).
...
We used a range of neuronal Gal4 drivers that cover known sleep centers to knockdown DmCa\textsubscript{v}3, but none of them were capable of altering sleep (Fig. \ref{fig:S4}).
