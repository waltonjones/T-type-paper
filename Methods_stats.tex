...
Statistical analysis was performed using R (version 3.2.0)\cite{undefined}\cite{null} except data analysis of electrophysiological recordings (GraphPad, San Diego, CA, USA).
