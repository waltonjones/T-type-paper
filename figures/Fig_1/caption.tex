...
Averaged percent amplitudes (mean $\pm$ s.e.m.) from oocytes expressing DmCa\textsubscript{v}3 (\raisebox{3pt}{\scalebox{2}{$\bullet$}}) or Ca\textsubscript{v}3.1 ($\square$) are plotted against test potentials and fitted with Boltzmann equation. 
