\label{fig:4}
\textbf{ \emph{Ca-\alpha1T\textsuperscript{Gal4}} flies show rhythmic locomotion and homeostatic regulation of sleep.}
\\
...
\textbf{(b)} Transcriptional oscillation of the \emph{period} gene in \emph{Ca-\alpha1T\textsuperscript{Gal4}} under DD conditions. Black and red lines denote \emph{w\textsuperscript{1118}} and \emph{Ca-\alpha1T\textsuperscript{Gal4}}, respectively.
\emph{rp49} was used for normalization.
a.u., arbitrary unit.
\textbf{(c)} Percentage of lost sleep recovered (\% $\Delta$Sleep) over a 12 hr period after 24 hours of mechanically-induced sleep deprivation. \emph{w\textsuperscript{1118}} (n=35) and \emph{Ca-\alpha1T\textsuperscript{Gal4}} (n=33). 
