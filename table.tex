...
\multicolumn{1}{l}{{\bf Current kinetics ($-$20 mV)}} &  &  &  &  &  \\ \midrule \addlinespace
...
\multicolumn{1}{l}{{\bf Deactivation kinetics ($-$100 mV)}} &  &  &  &  &  \\ \midrule \addlinespace
$\tau$\textsubscript{deact} (ms) & 0.9 $\pm$ 0.1 (6)\tnote{a} & NA & 2.6 $\pm$ 0.2\tnote{a}\textsuperscript{,}\tnote{b}\cite{chemin:2002aa} & 3.6 $\pm$ 0.4\tnote{a}\textsuperscript{,}\tnote{b}\cite{chemin:2002aa} & {\bf 1.12 $\pm$ 0.1\tnote{a}\textsuperscript{,}\tnote{b}\cite{chemin:2002aa}} \\ \addlinespace
