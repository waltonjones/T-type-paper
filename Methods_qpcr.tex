...
Primers: \emph{per} (\seqsplit{5'-GACCGAATCCCTGCTCAATA-3'}, \seqsplit{5'-GTGTCATTGGCGGACTTCTT-3'}); \emph{rp49} (\seqsplit{5'-ATGACCATCCGCCCAGCATA-3'}, \seqsplit{5'-GAGAACGCAGGCGACCGTTG-3'}).
