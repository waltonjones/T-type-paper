...
\emph{DmCa\textsubscript{v}3\textsuperscript{Gal4}} flies show increased total sleep under both 12h:12h light-dark (LD) and continuous dark (DD) conditions, but this phenotype is particularly prominent during the subjective day in continuous darkness (Fig. \ref{fig:3}c and d).
The increase in total sleep observed for DmCa\textsubscript{v}3-null flies is rescued in \emph{DmCa\textsubscript{v}3\textsuperscript{Rescue}} flies, partially in LD conditions and completely in DD conditions (Fig. \ref{fig:3}c and d).
The cause of this partial rescue in LD conditions is unclear.
...
On the contrary, \emph{DmCa\textsubscript{v}3\textsuperscript{Gal4}} show slightly higher levels of waking activity than their respective controls (Fig. \ref{fig:3}e).
