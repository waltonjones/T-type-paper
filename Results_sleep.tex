...
In addition, knockdown of DmCa\textsubscript{v}3 in its own neurons (\emph{DmCa\textsubscript{v}3\textsuperscript{Gal4}\textgreater{}UAS-DmCa\textsubscript{v}3-IR}) increases sleep after the third day of continuous darkness (Fig. \ref{fig:S3}).
