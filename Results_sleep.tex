...
Interestingly, \emph{DmCa\textsubscript{v}3\textsuperscript{Gal4}} flies show increased sleep in 12h:12h light-dark cycle (LD) and this phenotype is particularly prominent in subjective daytime under continuous dark (DD) conditions (Fig. \ref{fig:3}c and d).
...
On the other hand, a averaged sleep bout length was increased both in LD and DD which was restored in \emph{DmCa\textsubscript{v}3\textsuperscript{Rescue}} (Fig. \ref{fig:3}g).
