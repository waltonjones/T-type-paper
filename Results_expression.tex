...
Consistent with our results using GFP::DmCa\textsubscript{v}3, \emph{DmCa\textsubscript{v}3\textsuperscript{Gal4}} drives the expression of a membrane-tethered mCherry (UAS-mChRFP) broadly across the brain (Fig. \ref{fig:S1}a).
