...
Consistent with \emph{GFP::DmCa\textsubscript{v}3}, \emph{DmCa\textsubscript{v}3\textsuperscript{Gal4}} showed broad expression pattern in the brain (Fig. \ref{fig:S1}a. We observed strong co-localization of the \emph{DmCa\textsubscript{v}3\textsuperscript{Gal4}}-driven mCherry signal and \emph{GFP::DmCa\textsubscript{v}3} in the neuropils (\ref{fig:S1}b and c}, suggesting both expressions are driven by the same endogenous DmCa\textsubscript{v}3 promoters.
