...
At test potentials ranging from \textminus50 mV to +20 mV,  DmCa\textsubscript{v}3 has slower current kinetics than Ca\textsubscript{v}3.1 (\emph{p}$<$ 0.01 for activation and \emph{p}$<$ 0.001 for inactivation, Student's t-test, Fig. \ref{fig:1}c).
